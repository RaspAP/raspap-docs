...
-   :material-clock-fast:{ .lg .middle } __Simple Setup__ [:octicons-arrow-right-24: Get started](simple-setup.md)
    ...
    The recommended approach for getting started with RaspAP, using a custom pre-built image that enables you to get started with minimal effort.

-   :material-clock-fast:{ .lg .middle } __Quick Installer__ [:octicons-arrow-right-24: Get started](troubleshooting.md)
    
    The Quick installer has been designed to assist users with creating an instance of RaspAP both quickly and with a great deal of flexibility on an existing Pi OS.
